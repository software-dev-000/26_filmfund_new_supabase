        ...
        <div className="flex lg:flex-row flex-col md:flex-row mb-12 gap-20">
          <div className="flex flex-col items-start ml-auto gap-4 justify-between">
            ...
            <div className="flex space-x-8 justify-center">
              ...
              <SocialIcon icon={<TelegramIcon style={{ fontSize: 20 }} />} to="https://t.me/FilmFundCommunity/" />
              <SocialIcon icon={<svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="28" height="28" viewBox="0,0,256,256">
...
</svg>} to="https://discord.com/invite/EN3g4SWYwV/" />
              
              {/* <SocialIcon icon={<DiscordIcon style={{ fontSize: 20 }} />} to="https://discord.com/invite/filmfund" /> */}
            </div>
          </div>
          ...
          <div className="flex flex-row gap-4 w-full justify-between lg:pr-20">
            ...
            <div className='col-span-1'>
              ...
              <ul className="space-y-3">
                ...
                <FooterLink to="https://filmfund.gitbook.io/docs">Whitepaper</FooterLink>
              </ul>
            </div>
